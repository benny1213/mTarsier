...
export const CLIENT_REGISTRY: ClientMeta[] = [
  ...
  },
  {
    ...
    name: "Trae",
    type: "IDE",
    docsUrl: "https://www.trae.ai/docs",
    configPath: "~/Library/Application Support/Trae/User/mcp.json",
    configPathWin: "%APPDATA%\\Trae\\User\\mcp.json",
    configPathLinux: null,
    configKey: "mcpServers",
    configFormat: "json",
  ...
  },
  {
    ...
    name: "Trae CN",
    type: "IDE",
    docsUrl: "https://www.trae.com.cn/docs",
    configPath: "~/Library/Application Support/Trae CN/User/mcp.json",
    configPathWin: "%APPDATA%\\Trae CN\\User\\mcp.json",
    configPathLinux: null,
    configKey: "mcpServers",
    configFormat: "json",
